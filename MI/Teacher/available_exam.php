...
<body>
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
      <a href="teacher_dash.php" class="btn btn-dark">&larr; Back to Dashboard</a>
  ...
  <script>
    ...
    function attemptExam(name, examDatetimeStr) {
      const examTime = new Date(examDatetimeStr);
      const now = new Date();
      ...
      if (now >= examTime) {
        ...
        alert(`Still the exam has not started. It will start at ${readableDate} and ${readableTime}.`);
      }
    }
  </script>
